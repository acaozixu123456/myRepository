...
try{
 for(const engine of ['chromium','webkit'])for(const viewport of [{width:390,height:844},{width:1280,height:900},{width:1536,height:960}]){
  ...
  stage=engine+' '+viewport.width+' normal root';await page.goto(base+'/',{waitUntil:'domcontentloaded'});await page.locator('[data-desktop-release="desktop-20260911-v4"]').waitFor();assert.equal(new URL(page.url()).pathname,'/companion.html');
